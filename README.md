...
# Note. DEPRECATED: Google have added `Chip` and `Chip Group` to the [28.0.0 Design library](https://developer.android.com/topic/libraries/support-library/revisions.html#28-0-0-alpha1), so I recommend using that.
